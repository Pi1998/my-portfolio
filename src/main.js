...
const data = [
  {
    ...
    img: 'public/project-img/toDoList.png',
  ...
  },
  {
    ...
    img: 'public/project-img/awesomeBook.png',
  ...
  },
  {
    ...
    img: 'public/project-img/marvelFolio.png',
  ...
  },
  {
    ...
    img: 'public/popup-img/Snapshoot-Portfolio-desktop.png',
...
const popUp = (i) => {
  ...
  //   data[i].img = 'public/popup-img/Snapshoot-Portfolio-mobile.png';
  ...
  <div class="see-project-container active">
        ...
        <div class="project-title-container">
          ...
          <div class="see-live-container">
            ...
            <a href="${data[i].linkLiveVersion}"><img src="public/popup-img/Icon-Export.png" alt="Image of export icon"></a>
          </div>
          <div class="see-source-container">
            <a href="${data[i].linkSource}">See source</a>
            <a href="${data[i].linkSource}"><img src="public/popup-img/Icon-GitHub.png" alt="Image of Github icon"></a>
          </div>
        </div>
